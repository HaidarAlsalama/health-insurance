...
const AddUser = () => {
  ...
  const handleSearchForThis = () => {
    axios.get(`${config.baseUrl1}/Persons/CheckInsuranceStatus?insuranceNumber=${ensuranceNumber}&year=${year}`).then(
      res => {
        ...
        <div className="w-full ">
          <div className="w-full  p-3 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 ">
            <div className="flex flex-col p-2">
              ...
              <input
                type="text"
                className="rounded-2xl p-2 mt-2 ml-10 w-full  md:ml-1 shadow-md outline-none focus:ring-1 ring-blue-400"
                ref={inputRef8}
                value={query}
            ...
            <div className="flex flex-col p-2">
              ...
              <input
                ...
                className="shadow appearance-none border text-gray-700 leading-tight outline-none focus:ring-1 ring-blue-400 rounded-2xl p-2 "
              />
            </div>
            {/* 
            <div className="flex flex-col p-2 ">
            ...
            <div className="flex flex-col p-2">
              ...
              <input
                ...
                className="rounded-2xl p-2 mt-2 ml-10 w-full bg-white md:ml-1 shadow-md"
              />
            </div>
          ...
          <div className="w-full p-4 ">
            <div className="flex gap-4 justify-start items-center mb-4 ">
              ...
              <div className="rounded-2xl p-2 mt-2 ml-10 w-full  md:ml-1 shadow-md outline-none focus:ring-1 ring-blue-400">
                <label
                  htmlFor="file-upload"
                  className=" md:text-sm"                >
                  استعراض صورة
          ...
          <div className="flex justify-between p-2  w-full">
            <div className="flex justify-center items-center bg-slate-600 shadow-md rounded-full py-2 w-48  h-10 ">
            ...
            <button
              className="flex justify-center items-center shadow-md rounded-full h-10 w-48 bg-slate-600 hover:bg-slate-700 disabled:bg-slate-400"
