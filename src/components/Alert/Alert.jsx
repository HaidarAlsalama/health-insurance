...
const Alert = () => {
  return (
    <div
      className="notifications overflow-hidden pb-2 fixed right-2 top-2 z-50 w-72 md:w-96_ flex flex-col gap-2"
...
export const createAlert = (
  ...
  h5.setAttribute("class", "font-bold !text-sm");
  ...
  alertBody.setAttribute(
    "class",
    "alert translate-x-full duration-1000 flex flex-col flex-start mb-2 z-50 !text-sm"
  );
